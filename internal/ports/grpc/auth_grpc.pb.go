...
const (
	...
	Auth_Check_FullMethodName          = "/auth.Auth/Check"
	Auth_GetProfile_FullMethodName     = "/auth.Auth/GetProfile"
	Auth_ChangeProfile_FullMethodName  = "/auth.Auth/ChangeProfile"
...
func (c *authClient) Check(ctx context.Context, in *CheckRequest, opts ...grpc.CallOption) (*CheckResponse, error) {
	...
	err := c.cc.Invoke(ctx, Auth_Check_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authClient) ChangeProfile(ctx context.Context, in *ChangeProfileRequest, opts ...grpc.CallOption) (*EmptyResponse, error) {
	out := new(EmptyResponse)
	err := c.cc.Invoke(ctx, Auth_ChangeProfile_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authClient) ChangePassword(ctx context.Context, in *ChangePasswordRequest, opts ...grpc.CallOption) (*EmptyResponse, error) {
	out := new(EmptyResponse)
...
func _Auth_ChangeProfile_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Auth_ChangeProfile_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var Auth_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "internal/ports/grpc/auth.proto",
}
